...
const CURRENT_BLACKLIST =
	"https://raw.githubusercontent.com/0x1618/disposable-email-domains/refs/heads/main/data/root.txt";
...
async function main() {
	...
	const active_blacklist = await filterDomainsWithMX(
		Array.from(blacklist) as string[],
	);
